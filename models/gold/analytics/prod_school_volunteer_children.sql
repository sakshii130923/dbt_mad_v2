...
SELECT
    vc.school_id::integer AS school_id,
    vc.school_name,
    vc.classes_with_volunteers,
    vc.classes_without_volunteers,
    COALESCE(mou.confirmed_child_count, 0)::integer AS confirmed_children,
    COALESCE(sm.active_child_count, 0)::bigint      AS children_in_system
