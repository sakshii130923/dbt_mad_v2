...
select
    ...
    -- Onboarded date wasn't explicit, but typically we take user created date. For parity keeping it NULL if missing from user.
    cast(null as timestamp) as "OnboardedDate",
